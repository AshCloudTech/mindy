...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info@mintyplumbing.co.uk';
 
    $mail->Password   = '@Mintyplumbing123';
 
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;
 
    $mail->setFrom('info@mintyplumbing.co.uk', 'Website Contact');
    $mail->addAddress('info@mintyplumbing.co.uk');
